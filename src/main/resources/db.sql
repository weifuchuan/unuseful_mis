...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`unuseful_mis` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin */;
...
CREATE TABLE `score` (
  ...
  `term` varchar(100) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `student` (
  ...
  `sex` varchar(2) COLLATE utf8mb4_bin NOT NULL DEFAULT '男',
  `birthday` date NOT NULL,
  `nation` varchar(32) COLLATE utf8mb4_bin NOT NULL,
  `native` varchar(32) COLLATE utf8mb4_bin NOT NULL,
